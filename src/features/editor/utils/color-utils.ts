...
// --- Types ---
export type ColorMode = "HEX" | "RGB" | "HSL" | "P3";
...
// Dumb parsing for now, assumes clean input or standard formats
// NOTE: Ideally use a library like 'colord' or 'tinycolor2' for production robustness.
export const parseColor = (color: string): RgbaColor => {
    ...
    // TODO: HSL and P3 parsing would go here. For now, fallback to black or existing hex logic.
...
export const rgbaToHslString = ({ r, g, b, a }: RgbaColor): string => {
