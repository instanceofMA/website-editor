...
export function initEditorRuntime() {
    ...
    class EditorRuntime {
        constructor() {
            ...
            this.isPreview =
                this.isStandalone ||
                sessionStorage.getItem("editor_preview_mode") === "true";
        ...
        initStyles() {
            ...
            style.textContent = `
                html.editor-mode [data-editor-highlight] {
                    outline: 2px dashed rgba(0, 153, 255, 0.5) !important;
            ...
            switch (data.type) {
                ...
                case "UPDATE_TEXT":
                    if (this.selectedElement)
                        this.selectedElement.innerText = data.value;
                    break;
                ...
                case "UPDATE_CSS_RULE":
                    ...
                    if (
                        ...
                        this.selectedElement.matches(data.selector)
                    ) {
                        setTimeout(
                            () => this.selectElement(this.selectedElement),
                            0,
        ...
        updateMode(isPreview) {
            ...
            if (this.isPreview) {
                ...
                document
                    .querySelectorAll(
                        "[data-editor-highlight], [data-editor-selected]",
                    )
                    .forEach((el) => {
...
export const EDITOR_SCRIPT = `(${initEditorRuntime.toString()})();`;
